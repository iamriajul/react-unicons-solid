...
// src/icons/uis-scenery.tsx
var uis_scenery_exports = {};
__export(uis_scenery_exports, {
  default: () => uis_scenery_default
});
module.exports = __toCommonJS(uis_scenery_exports);
...
var uis_scenery_default = UisScenery;
