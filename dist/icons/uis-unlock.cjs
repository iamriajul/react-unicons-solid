...
// src/icons/uis-unlock.tsx
var uis_unlock_exports = {};
__export(uis_unlock_exports, {
  default: () => uis_unlock_default
});
module.exports = __toCommonJS(uis_unlock_exports);
...
var uis_unlock_default = UisUnlock;
