...
// src/icons/uis-check.tsx
var uis_check_exports = {};
__export(uis_check_exports, {
  default: () => uis_check_default
});
module.exports = __toCommonJS(uis_check_exports);
...
var uis_check_default = UisCheck;
