...
// src/icons/uis-align-left.tsx
var uis_align_left_exports = {};
__export(uis_align_left_exports, {
  default: () => uis_align_left_default
});
module.exports = __toCommonJS(uis_align_left_exports);
...
var uis_align_left_default = UisAlignLeft;
