...
// src/icons/uis-padlock.tsx
var uis_padlock_exports = {};
__export(uis_padlock_exports, {
  default: () => uis_padlock_default
});
module.exports = __toCommonJS(uis_padlock_exports);
...
var uis_padlock_default = UisPadlock;
