...
// src/icons/uis-signal-alt.tsx
var uis_signal_alt_exports = {};
__export(uis_signal_alt_exports, {
  default: () => uis_signal_alt_default
});
module.exports = __toCommonJS(uis_signal_alt_exports);
...
var uis_signal_alt_default = UisSignalAlt;
