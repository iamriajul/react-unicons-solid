...
// src/icons/uis-border-alt.tsx
var uis_border_alt_exports = {};
__export(uis_border_alt_exports, {
  default: () => uis_border_alt_default
});
module.exports = __toCommonJS(uis_border_alt_exports);
...
var uis_border_alt_default = UisBorderAlt;
