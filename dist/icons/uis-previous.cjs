...
// src/icons/uis-previous.tsx
var uis_previous_exports = {};
__export(uis_previous_exports, {
  default: () => uis_previous_default
});
module.exports = __toCommonJS(uis_previous_exports);
...
var uis_previous_default = UisPrevious;
