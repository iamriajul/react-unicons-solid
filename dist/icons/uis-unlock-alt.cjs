...
// src/icons/uis-unlock-alt.tsx
var uis_unlock_alt_exports = {};
__export(uis_unlock_alt_exports, {
  default: () => uis_unlock_alt_default
});
module.exports = __toCommonJS(uis_unlock_alt_exports);
...
var uis_unlock_alt_default = UisUnlockAlt;
