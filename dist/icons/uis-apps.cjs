...
// src/icons/uis-apps.tsx
var uis_apps_exports = {};
__export(uis_apps_exports, {
  default: () => uis_apps_default
});
module.exports = __toCommonJS(uis_apps_exports);
