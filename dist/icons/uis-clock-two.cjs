...
// src/icons/uis-clock-two.tsx
var uis_clock_two_exports = {};
__export(uis_clock_two_exports, {
  default: () => uis_clock_two_default
});
module.exports = __toCommonJS(uis_clock_two_exports);
...
var uis_clock_two_default = UisClockTwo;
