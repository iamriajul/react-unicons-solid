...
// src/icons/uis-analytics.tsx
var uis_analytics_exports = {};
__export(uis_analytics_exports, {
  default: () => uis_analytics_default
});
module.exports = __toCommonJS(uis_analytics_exports);
...
var uis_analytics_default = UisAnalytics;
