...
// src/icons/uis-lock-alt.tsx
var uis_lock_alt_exports = {};
__export(uis_lock_alt_exports, {
  default: () => uis_lock_alt_default
});
module.exports = __toCommonJS(uis_lock_alt_exports);
...
var uis_lock_alt_default = UisLockAlt;
