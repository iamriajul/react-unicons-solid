...
// src/icons/uis-link-h.tsx
var uis_link_h_exports = {};
__export(uis_link_h_exports, {
  default: () => uis_link_h_default
});
module.exports = __toCommonJS(uis_link_h_exports);
...
var uis_link_h_default = UisLinkH;
