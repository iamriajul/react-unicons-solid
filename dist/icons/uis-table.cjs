...
// src/icons/uis-table.tsx
var uis_table_exports = {};
__export(uis_table_exports, {
  default: () => uis_table_default
});
module.exports = __toCommonJS(uis_table_exports);
...
var uis_table_default = UisTable;
