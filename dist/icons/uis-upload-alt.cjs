...
// src/icons/uis-upload-alt.tsx
var uis_upload_alt_exports = {};
__export(uis_upload_alt_exports, {
  default: () => uis_upload_alt_default
});
module.exports = __toCommonJS(uis_upload_alt_exports);
...
var uis_upload_alt_default = UisUploadAlt;
