...
// src/icons/uis-polygon.tsx
var uis_polygon_exports = {};
__export(uis_polygon_exports, {
  default: () => uis_polygon_default
});
module.exports = __toCommonJS(uis_polygon_exports);
...
var uis_polygon_default = UisPolygon;
