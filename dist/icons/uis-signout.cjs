...
// src/icons/uis-signout.tsx
var uis_signout_exports = {};
__export(uis_signout_exports, {
  default: () => uis_signout_default
});
module.exports = __toCommonJS(uis_signout_exports);
...
var uis_signout_default = UisSignout;
