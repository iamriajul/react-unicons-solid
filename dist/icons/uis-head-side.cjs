...
// src/icons/uis-head-side.tsx
var uis_head_side_exports = {};
__export(uis_head_side_exports, {
  default: () => uis_head_side_default
});
module.exports = __toCommonJS(uis_head_side_exports);
...
var uis_head_side_default = UisHeadSide;
