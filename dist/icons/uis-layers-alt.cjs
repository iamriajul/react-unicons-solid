...
// src/icons/uis-layers-alt.tsx
var uis_layers_alt_exports = {};
__export(uis_layers_alt_exports, {
  default: () => uis_layers_alt_default
});
module.exports = __toCommonJS(uis_layers_alt_exports);
...
var uis_layers_alt_default = UisLayersAlt;
