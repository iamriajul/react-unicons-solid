...
// src/icons/uis-multiply.tsx
var uis_multiply_exports = {};
__export(uis_multiply_exports, {
  default: () => uis_multiply_default
});
module.exports = __toCommonJS(uis_multiply_exports);
...
var uis_multiply_default = UisMultiply;
