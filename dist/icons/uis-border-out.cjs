...
// src/icons/uis-border-out.tsx
var uis_border_out_exports = {};
__export(uis_border_out_exports, {
  default: () => uis_border_out_default
});
module.exports = __toCommonJS(uis_border_out_exports);
...
var uis_border_out_default = UisBorderOut;
