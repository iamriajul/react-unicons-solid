...
// src/icons/uis-sorting.tsx
var uis_sorting_exports = {};
__export(uis_sorting_exports, {
  default: () => uis_sorting_default
});
module.exports = __toCommonJS(uis_sorting_exports);
...
var uis_sorting_default = UisSorting;
