...
// src/icons/uis-subject.tsx
var uis_subject_exports = {};
__export(uis_subject_exports, {
  default: () => uis_subject_default
});
module.exports = __toCommonJS(uis_subject_exports);
...
var uis_subject_default = UisSubject;
