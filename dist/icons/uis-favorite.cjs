...
// src/icons/uis-favorite.tsx
var uis_favorite_exports = {};
__export(uis_favorite_exports, {
  default: () => uis_favorite_default
});
module.exports = __toCommonJS(uis_favorite_exports);
...
var uis_favorite_default = UisFavorite;
