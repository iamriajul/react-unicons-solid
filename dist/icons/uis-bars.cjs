...
// src/icons/uis-bars.tsx
var uis_bars_exports = {};
__export(uis_bars_exports, {
  default: () => uis_bars_default
});
module.exports = __toCommonJS(uis_bars_exports);
