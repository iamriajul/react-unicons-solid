...
// src/icons/uis-clock-ten.tsx
var uis_clock_ten_exports = {};
__export(uis_clock_ten_exports, {
  default: () => uis_clock_ten_default
});
module.exports = __toCommonJS(uis_clock_ten_exports);
...
var uis_clock_ten_default = UisClockTen;
