...
// src/icons/uis-analysis.tsx
var uis_analysis_exports = {};
__export(uis_analysis_exports, {
  default: () => uis_analysis_default
});
module.exports = __toCommonJS(uis_analysis_exports);
...
var uis_analysis_default = UisAnalysis;
