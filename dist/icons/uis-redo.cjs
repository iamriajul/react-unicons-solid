...
// src/icons/uis-redo.tsx
var uis_redo_exports = {};
__export(uis_redo_exports, {
  default: () => uis_redo_default
});
module.exports = __toCommonJS(uis_redo_exports);
