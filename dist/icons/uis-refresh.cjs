...
// src/icons/uis-refresh.tsx
var uis_refresh_exports = {};
__export(uis_refresh_exports, {
  default: () => uis_refresh_default
});
module.exports = __toCommonJS(uis_refresh_exports);
...
var uis_refresh_default = UisRefresh;
