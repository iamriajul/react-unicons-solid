...
// src/icons/uis-direction.tsx
var uis_direction_exports = {};
__export(uis_direction_exports, {
  default: () => uis_direction_default
});
module.exports = __toCommonJS(uis_direction_exports);
...
var uis_direction_default = UisDirection;
