...
// src/icons/uis-clock.tsx
var uis_clock_exports = {};
__export(uis_clock_exports, {
  default: () => uis_clock_default
});
module.exports = __toCommonJS(uis_clock_exports);
...
var uis_clock_default = UisClock;
