...
// src/icons/uis-history.tsx
var uis_history_exports = {};
__export(uis_history_exports, {
  default: () => uis_history_default
});
module.exports = __toCommonJS(uis_history_exports);
...
var uis_history_default = UisHistory;
