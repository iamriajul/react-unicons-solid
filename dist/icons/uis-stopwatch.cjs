...
// src/icons/uis-stopwatch.tsx
var uis_stopwatch_exports = {};
__export(uis_stopwatch_exports, {
  default: () => uis_stopwatch_default
});
module.exports = __toCommonJS(uis_stopwatch_exports);
...
var uis_stopwatch_default = UisStopwatch;
