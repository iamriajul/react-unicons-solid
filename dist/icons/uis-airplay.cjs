...
// src/icons/uis-airplay.tsx
var uis_airplay_exports = {};
__export(uis_airplay_exports, {
  default: () => uis_airplay_default
});
module.exports = __toCommonJS(uis_airplay_exports);
...
var uis_airplay_default = UisAirplay;
